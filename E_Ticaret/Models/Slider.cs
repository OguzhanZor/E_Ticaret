...
namespace E_Ticaret.Models
{
	public class Slider
	{
		...
		[StringLength(300, ErrorMessage = "Görsel URL'si en fazla {1} karakter olabilir")]
		public string ImageUrl { get; set; } = string.Empty;

		[StringLength(300, ErrorMessage = "Mobil görsel URL'si en fazla {1} karakter olabilir")]
